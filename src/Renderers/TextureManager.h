...
public:
	...
	Vec4_f32x16 gatherLinearIntesitiesFromMultipleTextures(const int32x16& textureInd, const float32x16& u, const float32x16& v, const mask16d& mask) const;
	float32x16 gatherAlphaFromMultipleTextures(const int32x16& textureInd, const float32x16& u, const float32x16& v, const mask16d& mask) const;
private:
	TextureManager();
