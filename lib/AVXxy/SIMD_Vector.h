...
namespace AVXXY_NAMESPACE
{
	...
	struct alignas(std::min(64ull, sizeof(_S)* _N)) SIMD_Vector
	{
		...
		SIMD_Vector(const T& s) { for (size_t i = 0; i < LaneCount; ++i) (*this)[i] = s; }
		...
		SIMD_Vector(T0 s0, T1 s1)
		{
			(*this)[0] = s0; (*this)[1] = s1;
		}
		template <typename T0, typename T1, typename T2, typename T3>
			requires (LaneCount == 4)
		SIMD_Vector(T0 s0, T1 s1, T2 s2, T3 s3)
		{
			(*this)[0] = s0; (*this)[1] = s1; (*this)[2] = s2; (*this)[3] = s3;
		}
		template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7>
			requires (LaneCount == 8)
		SIMD_Vector(T0 s0, T1 s1, T2 s2, T3 s3, T4 s4, T5 s5, T6 s6, T7 s7)
		{
			(*this)[0] = s0; (*this)[1] = s1; (*this)[2] = s2; (*this)[3] = s3;
		...
		template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8,
			...
			requires (LaneCount == 16)
		SIMD_Vector(T0 s0, T1 s1, T2 s2, T3 s3, T4 s4, T5 s5, T6 s6, T7 s7, T8 s8, T9 s9, T10 s10, T11 s11, T12 s12, T13 s13, T14 s14, T15 s15)
		{
			(*this)[0] = s0; (*this)[1] = s1; (*this)[2] = s2; (*this)[3] = s3;
			(*this)[4] = s4; (*this)[5] = s5; (*this)[6] = s6; (*this)[7] = s7;
		...
		template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10, typename T11, typename T12, typename T13, typename T14, typename T15, typename T16, typename T17, typename T18, typename T19, typename T20, typename T21, typename T22, typename T23, typename T24, typename T25, typename T26, typename T27, typename T28, typename T29, typename T30, typename T31>
			requires (LaneCount == 32)
		SIMD_Vector(T0 s0, T1 s1, T2 s2, T3 s3, T4 s4, T5 s5, T6 s6, T7 s7, T8 s8, T9 s9, T10 s10, T11 s11, T12 s12, T13 s13, T14 s14, T15 s15, T16 s16, T17 s17, T18 s18, T19 s19, T20 s20, T21 s21, T22 s22, T23 s23, T24 s24, T25 s25, T26 s26, T27 s27, T28 s28, T29 s29, T30 s30, T31 s31)
		{
			(*this)[0] = s0; (*this)[1] = s1; (*this)[2] = s2; (*this)[3] = s3;
			(*this)[4] = s4; (*this)[5] = s5; (*this)[6] = s6; (*this)[7] = s7;
			(*this)[8] = s8; (*this)[9] = s9; (*this)[10] = s10; (*this)[11] = s11;
